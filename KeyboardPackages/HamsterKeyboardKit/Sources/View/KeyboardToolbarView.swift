  ...
  override func activateViewConstraints() {
    ...
    if keyboardContext.displayKeyboardDismissButton {
      constraints.append(contentsOf: [
        ...
        emojiButton.trailingAnchor.constraint(equalTo: dismissKeyboardButton.leadingAnchor, constant: -4),
      ])
    } else {
      constraints.append(
        emojiButton.trailingAnchor.constraint(equalTo: commonFunctionBar.trailingAnchor)
      )
    }
