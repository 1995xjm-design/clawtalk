//
//  ClassifySymbolicMoreKeyboard.swift
//
//  ClawTalk「IOS原生」中文拓展符号子面板（中文符号页「#+=」进入，按文档）。
//
...
/// 中文拓展符号子面板（ClawTalk IOS原生，按文档）
/// 行1：， | 。 | 、 | ； | 删除
/// 行2：： | ？ | ！ | … | —
/// 行3：「 | 」 | 『 | 』
/// 行4：（ | ） | 【 | 】 | 123
/// 行5：ABC | ， | 空格 | 。 | 发送/换行
class ClassifySymbolicMoreKeyboard: KeyboardTouchView {
