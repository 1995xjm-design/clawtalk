//
//  LegacyNumericNineGridKeyboard.swift
//
//
...
/// 数字九宫格键盘
public class LegacyNumericNineGridKeyboard: KeyboardTouchView, UICollectionViewDelegate {
  // MARK: - Properties

  private let keyboardLayoutProvider: LegacyNumericNineGridKeyboardLayoutProvider
  ...
  init(
    ...
    self.keyboardLayoutProvider = LegacyNumericNineGridKeyboardLayoutProvider(keyboardContext: keyboardContext)
...
public extension LegacyNumericNineGridKeyboard {
